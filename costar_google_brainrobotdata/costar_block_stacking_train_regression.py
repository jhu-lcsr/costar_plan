...
def main(_):
    ...
    if FLAGS.load_hyperparams is None:
        ...
        # 2018-07-26 #1 COORDCONV applied to initial input image, 3rd best best performing overall of about 700 hyperopt results (ABOUT TO BE RUN, BUT ENCOUNTERED BUG)
        FLAGS.load_hyperparams = ('hyperopt_logs_costar_grasp_regression/2018-07-26-10-48-52_vgg_semantic_grasp_regression_model-_img_vgg_vec_dense_trunk_vgg_conv_block-dataset_costar_block_stacking-grasp_goal_xyz_aaxyz_nsc_8/2018-07-26-10-48-52_vgg_semantic_grasp_regression_model-_img_vgg_vec_dense_trunk_vgg_conv_block-dataset_costar_block_stacking-grasp_goal_xyz_aaxyz_nsc_8_hyperparams.json')

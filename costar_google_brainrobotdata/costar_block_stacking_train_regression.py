    ...
    if FLAGS.load_hyperparams is None:
        ...
        if (problem_type == 'semantic_translation_regression' or problem_type == 'semantic_grasp_regression') and use_best_model:
            ...
            if problem_type == 'semantic_translation_regression' and load_best_weights:
                ...
                load_weights = './logs_cornell/2018-09-20-19-46-12_train_0.4_gripper_center-nasnet_mobile_semantic_translation_regression_model--dataset_costar_block_stacking-grasp_goal_xyz_3/2018-09-20-19-46-12_train_0.4_gripper_center-nasnet_mobile_semantic_translation_regression_model--dataset_costar_block_stacking-grasp_goal_xyz_3-epoch-463-val_loss-0.000-val_cart_error-0.028.h5'
